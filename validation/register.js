...
module.exports = function validateRegisterInput(data) {
    ...
    if(!Validator.isLength(data.password_confirmation, {min: 6, max: 30})) {
        errors.password_confirmation = 'Password must have 6 chars';
    }

    if(!Validator.equals(data.password, data.password_confirmation)) {
        errors.password_confirmation = 'Password and Confirm Password must match';
    }
